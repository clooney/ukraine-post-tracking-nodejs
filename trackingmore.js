...
//2 识别一个运输商
// var postData = {"tracking_number":"RE020577676UA"};
...
//4 获取多个运单号的物流信息
// var postData = null;
// var url      = 'http://api.trackingmore.com/v2/trackings/get?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=&numbers=RE020577676UA&orders=&lang=cn';
// sentRes(url,postData,"GET",function(data){
//     console.log(data);
// });
...
//5 列出单个运单号物流信息
// var postData = null;
// var url      = 'http://api.trackingmore.com/v2/trackings/ukraine-post/RE020577676UA/en';
// sentRes(url,postData,"GET",function(data){
//     console.log(data);
// });
...
// var url       = 'http://api.trackingmore.com/v2/trackings/ukraine-post/RE020577676UA';
...
//10 设置单号不再更新
// var postData = [
//     {"tracking_number":"RE020577676UA","carrier_code":"ukraine-post"},
...
// var postData = [{"carrier_code":"ukraine-post","destination":"US","original":"CN"},{"carrier_code":"china-ems","destination":"US","original":"CN"}];
...
//13 创建多个跟踪项目
// var postData = [
//     {"tracking_number": "RE020577676UA","carrier_code":"ukraine-post","title":"4PX page","customer_name":"trackingmore user","customer_email":"service@trackingmore.com","order_id":"#123","order_create_time":"2018/09/08 16:51","destination_code":"US","tracking_ship_date":"20180908","tracking_postal_code":"12201","lang":"en","logistics_channel":"API TEST"},
...
//14 修改多个运单号附加信息
// var postData = [
//     {"tracking_number":"RE020577676UA","carrier_code":"ukraine-post","title":"4PX page","customer_name":"trackingmore user","customer_email":"service@trackingmore.com","order_id":"#123","destination_code":"US","status":"7","logistics_channel":"API TEST"},
...
//16 修改运输商简码
// var postData = {"tracking_number":"RE020577676UA","carrier_code":"ukraine-post","update_carrier_code":"china-ems"};
...
//17 获取单次跟踪的实时结果
// var postData = {"tracking_number": "RE020577676UA","carrier_code":"ukraine-post","destination_code": "US","tracking_ship_date":"20180908","tracking_postal_code":"12201","specialNumberDestination":"UK","order":"#123","order_create_time":"2018/09/08 16:51","lang":"en"};
